...
class Server_Client extends Thread //처리해주는 곳(소켓에 대한 정보가 담겨있는 곳. 소켓을 처리함)
{
	...
	//생성자
	public Server_Client(Socket socket, List <Server_Client> list) throws IOException {
	...
	public void broadcast(InfoDTO sendDto) throws IOException {
		for(Server_Client handler: list){
